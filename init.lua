...
do
	...
	-- checks if the version is out of date, commented out because i'm too lazy to update this amazing crack.
	...
	-- disables the plugin if the version is out of date, commented out because i'm too lazy to update this amazing crack.
